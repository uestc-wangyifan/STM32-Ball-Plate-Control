...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
// 初始化PID
pid_x.Kp = 1.2f; pid_x.Ki = 0.05f; pid_x.Kd = 0.3f; pid_x.integral = 0; pid_x.last_error = 0;
pid_y.Kp = 1.2f; pid_y.Ki = 0.05f; pid_y.Kd = 0.3f; pid_y.integral = 0; pid_y.last_error = 0;
